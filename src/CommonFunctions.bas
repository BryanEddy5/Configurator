...
Sub ListFiles(fld As Object, Mask As String)
    ...
    For Each fl In fld.Files
        If fl.Name Like Mask Then
            ...
            FileCopy fld.Path & "\" & fl.Name, modImages.ImagesCablePath & GetNewImageNameFromFileName(fl.Name, fld.Path)
...
sBurnListing = sBurnListing & " " & ExtractTextFromString("FT", printLine, " ")
