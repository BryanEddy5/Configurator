Attribute VB_Name = "Subunit_X_Loop"
...
'DoCmd.Close acForm, "frmUnitSeriesCount"


'if statement determines which set of subunits (mm or sm) should come first on the Subunit Print Sheet




'DoCmd.OpenQuery "qryNewBasicConstructionClear"          'Clears table to append sub to for creation



'Loop that iteratively identifies if a subunit exists the appends to the unit series table or creates a new item and appends it to the unit series table
